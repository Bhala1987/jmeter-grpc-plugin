...
import jmeter.grpc.client.GrpcClientInterceptor;
import jmeter.grpc.client.GrpcClientSampler;
import jmeter.grpc.compiler.StringGeneratedJavaCompilerFacade;
...
public class GrpcUtils {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(jmeter.grpc.utils.GrpcUtils.class);
    private static final transient ClassLoader classLoader = jmeter.grpc.utils.GrpcUtils.class.getClassLoader();
    ...
    public static AbstractStub<?> getBlockingStub(GrpcClientSampler sampler, Channel channel)
        ...
        Class<?> serviceGrpcClass = classLoader.loadClass(jmeter.grpc.utils.GrpcUtils.getGrpcServiceClass(sampler));
        Method newBlockingStubMethod = serviceGrpcClass.getMethod(jmeter.grpc.utils.GrpcUtils.NEW_BLOCKING_STUB, Channel.class);
